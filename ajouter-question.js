...
document.getElementById('add-proposition').addEventListener('click', () => {
    ...
    container.className = 'proposition-container';
    
    const checkbox = document.createElement('input');
    checkbox.type = 'checkbox';
    checkbox.name = 'correcte';
    ...
    container.append(checkbox, input, removeBtn);
...
document.getElementById('form-question').addEventListener('submit', function(e) {
    ...
    if (!exam) {
        alert(`Examen "${nomExamen}" non trouvé pour ${proprietaire}`);
        return;
    }
